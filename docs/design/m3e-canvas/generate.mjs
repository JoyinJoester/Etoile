...
reader.button(200, '全屏阅读', 'reader-fullscreen', { icon: 'fullscreen', variant: 'tonal', note: '隐藏仓库导航，只保留文件名、分支、退出全屏和打开 GitHub；代码区域扩展到整屏。' });
reader.card(264, 'Etoile', '在 Android 上浏览项目、处理通知、审查代码。\n\n三种可切换的视觉风格，使用同一份账户和仓库数据。', { size2: 260 });
reader.list(548, [['快速开始', '阅读安装与登录说明', 'menu_book'], ['下载最新版本', '打开发布版本', 'download', 'releases']]);
const readerFullscreen = screen(repos, 'reader-fullscreen', 'README.md · 全屏阅读', '代码和正文占满屏幕；顶部只保留退出全屏、文件名、分支和打开 GitHub。选择与横向滚动仍然可用。', { root: true });
readerFullscreen.caption(104, '退出全屏  ·  Etoile / android · main');
readerFullscreen.button(144, '退出全屏', 'reader', { icon: 'fullscreen_exit', variant: 'tonal' });
readerFullscreen.card(208, 'README.md', '# Etoile\n\n你的 Android GitHub 工作空间。\n\n支持代码选择、搜索与横向滚动。', { size2: 560, fill: 'surfaceContainerLow' });
...
const job = screen(ops, 'job', '作业日志', '步骤名称全宽，状态在名称下方。首次打开自动换行，确保手机上长路径完整可读；可切换横向滚动查看原始日志，截断必须说明。'); job.list(104, [['Checkout', '成功', 'check_circle'], ['Assemble debug', '失败', 'error']]); job.button(272, '横向滚动', null, { variant: 'tonal', icon: 'swap_horiz', toggle: { label: '自动换行', icon: 'wrap_text', variant: 'filled' } }); job.card(352, '构建日志', '> Task :app:assembleDebug\n完整日志可选择、滚动或在 GitHub 打开。', { size2: 288, fill: 'surfaceContainerLow' });
const app = screen(ops, 'app', 'Etoile', '仓库身份、发布版本与可安装文件分组。顶栏固定显示站内详情、分享和浏览器入口；下载完成后安装按钮明确反馈系统安装器是否可用。'); app.card(104, 'Etoile', 'Android GitHub 工作空间', { icon: 'android', fill: 'primaryContainer', size2: 148 }); app.button(272, '查看项目详情', 'repository', { icon: 'code', variant: 'tonal' }); app.button(272, '分享项目', null, { x: 220, icon: 'share', variant: 'tonal' }); app.list(352, [['最新版本', '0.1 · 查看发布说明', 'new_releases'], ['arm64-v8a.apk', '适合当前设备 · 下载 APK', 'download']]); app.button(528, '下载 APK', null, { icon: 'download' }); app.part('linearProgress', 16, 612, '', { value: 42, wavy: true }); app.caption(660, '下载进度、取消和安装反馈固定在文件行下方；详情内容上下滚动时顶栏不移动。');
